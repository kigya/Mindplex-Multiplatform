            ...
            Column(
                ...
                MindplexHorizontalPager(
                    ...
                    Column(
                        ...
                        AnimatedVisibility(visible = state.shouldDisplayTitle) {
                            get(page).titleTextResource?.let { titleResource ->
                                MindplexText(
                                    modifier = Modifier
                                        .fillMaxWidth()
                        ...
                        AnimatedVisibility(visible = state.shouldDisplayDescription) {
                            get(page).descriptionTextResource?.let { descriptionResource ->
                                MindplexText(
                                    modifier = Modifier
                                        .fillMaxWidth()
                                        .padding(horizontal = MaterialTheme.spacing.large),
                ...
                AnimatedContent(
                    ...
                    Row(
                        ...
                        get(page).skipButtonTextResource?.let { skipResource ->
                            AnimatedVisibility(
                        ...
                        get(page).nextButtonTextResource?.let { nextResource ->
                            MindplexButton(
                                modifier = Modifier.weight(1f),
